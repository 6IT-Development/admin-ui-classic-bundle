...
{
    #[Route('/user/tree-get-children-by-id', name: 'pimcore_admin_user_treegetchildrenbyid', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/add', name: 'pimcore_admin_user_add', methods: [Request::METHOD_POST])]
    ...
    #[Route('/user/delete', name: 'pimcore_admin_user_delete', methods: [Request::METHOD_DELETE])]
    ...
    #[Route('/user/update', name: 'pimcore_admin_user_update', methods: [Request::METHOD_PUT])]
    ...
    ): JsonResponse
    {
        ...
        if ($request->get('data')) {
            ...
            if ($request->get('workspaces')) {
                ...
                $workspaces = $this->decodeJson($request->get('workspaces'));
    ...
    #[Route('/user/get', name: 'pimcore_admin_user_get', methods: [Request::METHOD_GET])]
    public function getAction(Request $request): JsonResponse
    {
        ...
        $contentLanguages = Admin::reorderWebsiteLanguages($user, Tool::getValidLanguages());
    ...
    #[Route('/user/get-minimal', name: 'pimcore_admin_user_getminimal', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/upload-current-user-image', name: 'pimcore_admin_user_uploadcurrentuserimage', methods: [Request::METHOD_POST])]
    ...
    #[Route('/user/update-current-user', name: 'pimcore_admin_user_updatecurrentuser', methods: [Request::METHOD_PUT])]
    ...
    #[Route('/user/get-current-user', name: 'pimcore_admin_user_getcurrentuser', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/role-tree-get-children-by-id', name: 'pimcore_admin_user_roletreegetchildrenbyid', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/role-get', name: 'pimcore_admin_user_roleget', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/upload-image', name: 'pimcore_admin_user_uploadimage', methods: [Request::METHOD_POST])]
    ...
    #[Route('/user/delete-image', name: 'pimcore_admin_user_deleteimage', methods: [Request::METHOD_DELETE])]
    ...
    #[Route('/user/disable-2fa', name: 'pimcore_admin_user_disable2fasecret', methods: [Request::METHOD_DELETE])]
    ...
    #[Route('/user/reset-2fa-secret', name: 'pimcore_admin_user_reset2fasecret', methods: [Request::METHOD_PUT])]
    ...
    #[Route('/user/reset-my-2fa-secret', name: 'pimcore_admin_user_reset_my_2fa_secret', methods: [Request::METHOD_PUT])]
    ...
    #[Route('/user/get-image', name: 'pimcore_admin_user_getimage', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/get-token-login-link', name: 'pimcore_admin_user_gettokenloginlink', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/search', name: 'pimcore_admin_user_search', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/get-users-for-sharing', name: 'pimcore_admin_user_getusersforsharing', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/get-roles-for-sharing', name: 'pimcore_admin_user_getrolesforsharing', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/get-users', name: 'pimcore_admin_user_getusers', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/get-roles', name: 'pimcore_admin_user_getroles', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/get-default-key-bindings', name: 'pimcore_admin_user_getdefaultkeybindings', methods: [Request::METHOD_GET])]
    ...
    #[Route('/user/invitationlink', name: 'pimcore_admin_user_invitationlink', methods: [Request::METHOD_POST])]
