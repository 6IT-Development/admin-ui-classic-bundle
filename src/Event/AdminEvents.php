...
class AdminEvents
{
     ...
     * @var string
     */
    public const string LOGIN_REDIRECT = 'pimcore.admin.login.redirect';
     ...
     * @var string
     */
    public const string LOGIN_LOSTPASSWORD = 'pimcore.admin.login.lostpassword';
     ...
     * @var string
     */
    public const string LOGIN_LOGOUT = 'pimcore.admin.login.logout';
     ...
     * @var string
     */
    public const string LOGIN_BEFORE_RENDER = 'pimcore.admin.login.beforeRender';
     ...
     * @var string
     */
    public const string INDEX_ACTION_SETTINGS = 'pimcore.admin.indexAction.settings';
     ...
     * @var string
     */
    public const string OBJECT_LIST_BEFORE_FILTER_PREPARE = 'pimcore.admin.object.list.beforeFilterPrepare';
     ...
     * @var string
     */
    public const string OBJECT_LIST_BEFORE_LIST_LOAD = 'pimcore.admin.object.list.beforeListLoad';
     ...
     * @var string
     */
    public const string OBJECT_LIST_BEFORE_EXPORT_PREPARE = 'pimcore.admin.object.list.beforeExportPrepare';
     ...
     * @var string
     */
    public const string OBJECT_LIST_BEFORE_EXPORT = 'pimcore.admin.object.list.beforeExport';
     ...
     * @var string
     */
    public const string OBJECT_LIST_AFTER_LIST_LOAD = 'pimcore.admin.object.list.afterListLoad';
     ...
     * @var string
     */
    public const string OBJECT_LIST_HANDLE_FULLTEXT_QUERY = 'pimcore.admin.object.list.handleFulltextQuery';
     ...
     * @var string
     */
    public const string ASSET_LIST_BEFORE_FILTER_PREPARE = 'pimcore.admin.asset.list.beforeFilterPrepare';
     ...
     * @var string
     */
    public const string ASSET_LIST_BEFORE_LIST_LOAD = 'pimcore.admin.asset.list.beforeListLoad';
     ...
     * @var string
     */
    public const string ASSET_GET_FIELD_GRID_CONFIG = 'pimcore.admin.asset.getFieldGridConfig';
     ...
     * @var string
     */
    public const string ASSET_LIST_AFTER_LIST_LOAD = 'pimcore.admin.asset.list.afterListLoad';
     ...
     * @var string
     */
    public const string ASSET_LIST_BEFORE_UPDATE = 'pimcore.admin.asset.list.beforeUpdate';
     ...
     * @var string
     */
    public const string ASSET_LIST_BEFORE_BATCH_UPDATE = 'pimcore.admin.asset.list.beforeBatchUpdate';
     ...
     * @var string
     */
    public const string DOCUMENT_LIST_BEFORE_FILTER_PREPARE = 'pimcore.admin.document.list.beforeFilterPrepare';
     ...
     * @var string
     */
    public const string DOCUMENT_LIST_BEFORE_LIST_LOAD = 'pimcore.admin.document.list.beforeListLoad';
     ...
     * @var string
     */
    public const string DOCUMENT_LIST_AFTER_LIST_LOAD = 'pimcore.admin.document.list.afterListLoad';
     ...
     * @var string
     */
    public const string ASSET_GET_PRE_SEND_DATA = 'pimcore.admin.asset.get.preSendData';
     ...
     * @var string
     */
    public const string ASSET_TREE_GET_CHILDREN_BY_ID_PRE_SEND_DATA = 'pimcore.admin.asset.treeGetChildrenById.preSendData';
     ...
     * @var string
     */
    public const string DOCUMENT_GET_PRE_SEND_DATA = 'pimcore.admin.document.get.preSendData';
     ...
     * @var string
     */
    public const string DOCUMENT_TREE_GET_CHILDREN_BY_ID_PRE_SEND_DATA = 'pimcore.admin.document.treeGetChildrenById.preSendData';
     ...
     * @var string
     */
    public const string OBJECT_GET_IS_LOCKED = 'pimcore.admin.dataobject.get.isLocked';
     ...
     * @var string
     */
    public const string OBJECT_GET_PRE_SEND_DATA = 'pimcore.admin.dataobject.get.preSendData';
     ...
     * @var string
     */
    public const string OBJECT_GRID_GET_COLUMN_CONFIG_PRE_SEND_DATA = 'pimcore.admin.dataobject.gridGetColumnConfig.preSendData';
     ...
     * @var string
     */
    public const string OBJECT_TREE_GET_CHILDREN_BY_ID_PRE_SEND_DATA = 'pimcore.admin.dataobject.treeGetChildrenById.preSendData';
     ...
     * @var string
     */
    public const string CLASS_FIELDCOLLECTION_LIST_PRE_SEND_DATA = 'pimcore.admin.class.fieldcollectionList.preSendData';
     ...
     * @var string
     */
    public const string CLASS_OBJECT_ICONS_PRE_SEND_DATA = 'pimcore.admin.class.dataobject.preSendData';
     ...
     * @var string
     */
    public const string CLASS_OBJECTBRICK_LIST_PRE_SEND_DATA = 'pimcore.admin.class.objectbrickList.preSendData';
     ...
     * @var string
     */
    public const string CLASS_OBJECTBRICK_UPDATE_DEFINITION = 'pimcore.admin.class.objectbrick.updateDefinition';
     ...
     * @var string
     */
    public const string CLASS_SELECTOPTIONS_LIST_PRE_SEND_DATA = 'pimcore.admin.class.selectoptionsList.preSendData';
     ...
     * @var string
     */
    public const string CLASS_SELECTOPTIONS_UPDATE_CONFIGURATION = 'pimcore.admin.class.selectoptions.updateDefinition';
     ...
     * @var string
     */
    public const string RESOLVE_ELEMENT = 'pimcore.admin.resolve.element';
     ...
     * @var string
     */
    public const string RESOLVE_ELEMENT_ADMIN_STYLE = 'pimcore.admin.resolve.elementAdminStyle';
     ...
     * @var string
     */
    public const string ASSET_METADATA_PRE_SET = 'pimcore.admin.asset.metadata.preSave';
     ...
     * @var string
     */
    public const string PERSPECTIVE_POST_GET_RUNTIME = 'pimcore.admin.perspective.postGetRuntime';
}
